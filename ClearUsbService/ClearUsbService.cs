    ...
    public partial class ClearUsbService : ServiceBase
    {
        ...
        private bool ClearUSBRecordsFromRegistry()
        {
            ...
            try
            {
                ...
                {
                    string[] controlsetKeys = systemkey.GetSubKeyNames();
                    foreach (string key in controlsetKeys)
                    {
                        if (key.Contains("ControlSet"))
                        {
                            ...
                            string[] a5d53fkeys = { "{a5dcbf10-6530-11d2-901f-00c04fb951ed}", "{53f56307-b6bf-11d0-94f2-00a0c91efb8b}" };
